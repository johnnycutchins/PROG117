...
namespace JohnnyCutchinsDVD
{
    public partial class Thanks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            mail.From = new MailAddress("cutchinsjohnny@gmail.com", "The DVD Store");
            // next address SHOULD be from user’s login, we’ll hardcode instead
            mail.To.Add(new MailAddress("jmcutch@outlook.com"));
            ...
            smtpClient.Credentials = new System.Net.NetworkCredential("cutchinsjohnny@gmail.com", "JC_9890*1");
